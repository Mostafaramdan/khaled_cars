...
Route::group(['prefix'=>'admin'], function (){
    ...
    Route::group(['middleware'=>'admin'], function (){
        ...
        Route::put('/biddings/updateStatus/{bidding}', [App\Http\Controllers\Admin\BiddingController::class, 'updateStatus'])->name('biddings.status');
        Route::GET ('/biddings/confirm/{bidding}', [App\Http\Controllers\Admin\BiddingController::class, 'confirm'])->name('biddings.confirm');
...
Route::group(['prefix'=>'employee'], function (){
  ...
  route::get('order/{orderpdf}/pdf',[App\Http\Controllers\Admin\OrderController::class,'pdf'])->name('order.pdf');
