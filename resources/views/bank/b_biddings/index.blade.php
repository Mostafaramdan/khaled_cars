                ...
                <div class="card-body">
                    <div class="table-responsive hoverable-table">
                        <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                            ...
                            <tbody>
                            @foreach ($b_biddings as $key => $b_bidding)
                                <tr>
                                    ...
                                    @if($b_bidding->type == 'open')
                                        ...
                                        <td>
                                            {!! Form::model($b_bidding,['route' => ['b_biddings.status' , $b_bidding->id], 'method' => 'put']) !!}
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ route('b_biddings.show', $b_bidding->id) }}" class="btn btn-sm btn-warning"
                                           title="تعديل"> <i class="las la-eye"></i> عرض </a>
                                        <a href="{{ route('b_biddings.edit', $b_bidding->id) }}" class="btn btn-sm btn-info"
                                           title="تعديل"> <i class="las la-pen"></i> تعديل</a>
                                        <button class="btn btn-danger btn-sm " data-id="{{ $b_bidding->id }}"
                                                data-name_ar="{{ $b_bidding->name_ar }}" data-toggle="modal"
        ...
        <div class="modal" id="modaldemo8">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    {{ Form::open(['route' => 'b_biddings.store', 'class' => 'parsley-style-1', 'method' => 'post']) }}
                    @csrf
        ...
        <div class="modal" id="modaldemo9">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content modal-content-demo">
                    ...
                    @if($b_biddings->count() != 0)
                        <form action="b_biddings/destroy" method="post">
                            {{ method_field('delete') }}
                            {{ csrf_field() }}
                            <div class="modal-body">
