...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">موظفين البنك</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ تعديل
                الموظف ( {{ $b_employee->name }} )</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('b_employees.index') }}">رجوع</a>
                        </div>
                    </div><br>
                    {!! Form::model($b_employee,['route' => ['b_employees.update' , $b_employee->id], 'method' => 'put']) !!}
