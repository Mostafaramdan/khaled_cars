                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="card card-dashboard-map-one">
                                ...
                                <br>
                                <div>
                                    {!! Html::decode(Form::label('permissions', 'الصلاحيات : <span class="tx-danger">*</span>'))!!}
                                    {!! Form::select('permissions',  array(null=>"كل الصلاحيات","add"=>"إضافة","edit" => "تعديل", "delete"=>"حذف"),old('permissions'), array( 'class' => 'form-control  nice-select  custom-select', 'tabindex' => '2',)) !!}
