                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="pull-right">
                            <a class="btn btn-primary" href="{{ route('regions.index') }}">رجوع</a>
                        </div>
                    </div><br>
                        ...
                        <div class="col-lg-12 col-xl-12">
                            <div class="card card-dashboard-map-one">
                                ...
                                <div>
                                    ...
                                    <input type="text" value="{{old('name_ar',$region->name_ar)}}" class="form-control" id="name_ar" name="name_ar" required>
                                    @error('name_ar')<span class="text-danger">{{ $message }}</span>@enderror
                                </div>
                                <br>
                                <div>
                                    <label for="exampleInputEmail1">الأسم بالانجليزية : <span class="tx-danger">*</span> </label>
                                    <input type="text" value="{{old('name_en',$region->name_en)}}" class="form-control" id="name_en" name="name_en" required>
