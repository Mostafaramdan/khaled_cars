        ...
        <div class="col-2">
            <div class="form-group">
                <select class="form-control"  name="status" id="status">
                    <option value=""     @if (old('status', request()->input('status')) == '')    SELECTED @endif>نوع الحالة</option>
                    <option value="coming"   @if (old('status', request()->input('status')) == 'coming')  SELECTED @endif >قادم</option>
                    <option value="waiting"   @if (old('status', request()->input('status')) == 'waiting')  SELECTED @endif >في الانتظار</option>
                </select>
            </div>
        </div>
        <div class="col-0">
